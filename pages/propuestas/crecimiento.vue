...
.propuestasRoot
	.encabezado
		h1.titulo Propuestas para el crecicmiento

	.programaBook
		iframe(
			src="https://docs.google.com/viewer?srcid=1l1dE2pCSTVS4YtpZ5C1XAmsWsmeaIs8B&pid=explorer&efh=false&a=v&chrome=false&embedded=true",
			width="100%",
			height="100%"
		)
